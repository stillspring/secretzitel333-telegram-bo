...
class Config:
    ...
    def _parse_other_responses(self, responses_str: str) -> List[str]:
        ...
        if not responses_str:
            ...
            return [
                "Твои попытки совсем далеки, так и быть, ты сможешь найти подсказку в городе Орловка - столице нашего мира. В одном из магазинов, где могут продаваться шипы - купи кактус, он поможет тебе узнать разгадку!",
                "Что?", "Подумай ещё.", "Не правильно!", "Ты не угадал!"
            ]
